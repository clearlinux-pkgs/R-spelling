...
Version  : 2.3.1
Release  : 57
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/spelling_2.3.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/spelling_2.3.1.tar.gz
...
popd
pushd ..
cp -a spelling buildavx512
popd
pushd ..
cp -a spelling buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740101303
